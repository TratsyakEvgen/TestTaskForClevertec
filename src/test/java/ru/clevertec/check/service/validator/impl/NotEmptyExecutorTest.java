...
class NotEmptyExecutorTest {
    ...
    void execute(TestObject testObject, List<Field> fields, List<String> expected) {
        ...
        Mockito.when(fieldScanner.findAnnotation(NotEmpty.class, testObject)).thenReturn(fields);
    ...
    void execute_incorrectField() {
        ...
        Mockito.when(fieldScanner.findAnnotation(NotEmpty.class, testObject))
